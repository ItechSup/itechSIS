...
use ItechSup\ItechSisBundle\Form\Type\TeacherType;
...
class TeacherController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ItechSupItechSisBundle:Teacher')->findAll();
     ...
     * @Method("POST")
     * @Template("ItechSupItechSisBundle:Teacher:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechSupItechSisBundle:Teacher')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechSupItechSisBundle:Teacher:edit.html.twig")
     */
