...
class StudentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ItechSupItechSisBundle:Student')->findAll();
     ...
     * @Method("POST")
     * @Template("ItechSupItechSisBundle:Student:new.html.twig")
     */
     ...
     * @Method("PUT")
     * @Template("ItechSupItechSisBundle:Student:edit.html.twig")
     */
