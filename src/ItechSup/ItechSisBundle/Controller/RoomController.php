...
class RoomController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ItechSupItechSisBundle:Room')->findAll();
     ...
     * @Method("POST")
     * @Template("ItechSupItechSisBundle:Room:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ItechSupItechSisBundle:Room')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("ItechSupItechSisBundle:Room:edit.html.twig")
     */
